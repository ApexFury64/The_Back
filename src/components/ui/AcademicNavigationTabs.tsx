...
export default function AcademicNavigationTabs() {
  ...
  return (
    <div className="flex bg-black/5 dark:bg-black/30 p-1.5 rounded-2xl border border-black/5 dark:border-white/5 w-full sm:w-fit mb-6 overflow-x-auto no-scrollbar gap-1">
      {tabs.map((tab) => {
